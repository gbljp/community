 ...
 * @date 2018/8/14
 */
public class MPGeneratorSqlserver {

    @Test
    public void generateCode() {
        String packageName = "com.anjoy.cloud.component";
        boolean serviceNameStartWithI = false;//user -> UserService, 设置成true: user -> IUserService
        generateByTables(serviceNameStartWithI, packageName, "ACT_GE_PROPERTY");
    }

    private void generateByTables(boolean serviceNameStartWithI, String packageName, String... tableNames) {
        GlobalConfig config = new GlobalConfig();
        String dbUrl = "jdbc:sqlserver://192.168.5.80:1433;DatabaseName=temp";
